...
cfg.merge_from_list(["MODEL.WEIGHT", "/media/SSD_1TB/ApolloScape/6DVNET_experiments/e2e_3d_car_101_FPN_triple_head/Jan24-03-56_n606_step/model_0010000.pth"])
...
img = Image.open(os.path.join(img_dir, img_files[0])).convert("RGB")
