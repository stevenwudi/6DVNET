...
# Loss coefficient
_C.MODEL.ROI_MASK_HEAD.MASK_LOSS_BETA = 1.0
...
_C.MODEL.ROI_CAR_CLS_ROT_HEAD.NUMBER_ROTS = 4
_C.MODEL.ROI_CAR_CLS_ROT_HEAD.SHARE_BOX_FEATURE_EXTRACTOR = True

_C.MODEL.ROI_CAR_CLS_ROT_HEAD.REGRESS_TARGET = ["labels", "car_cat_classes", "quaternions"]
...
_C.MODEL.ROI_CAR_CLS_ROT_HEAD.ROT_DIFF_DEGREE = False
_C.MODEL.ROI_CAR_CLS_ROT_HEAD.UNIQUE_CAR_MODELS = []
